...
public class DatabaseLoader {
     ...
     * @return Een genested ArrayList met daarin de bestand id en naam per ArrayList bijv. [["1","bestand1"],["2","bestand2"]]
    ...
    /**
     * Methode om de headers en sequentie op te halen die bij een bestandsID horen
     * @param bestandID int met daarin de bestandsID
     * @return Een genested ArrayList met daarin de sequentieID, header en de sequentie per ArrayList bijv. [["1",">header","agaga"],["2",">header2","tatata"]]
     * @throws SQLException wordt opgegooid als er een exception optreed bij de SQL server
     */
     ...
     * @param seqID int met de sequentie ID waarvan de ORF's moet worden opgehaald
     * @param seq String met daarin de sequentie waaruit de orf sequentie moet worden gehaald voor het ORF object
     ...
     * @throws SQLException wordt opgegooid als de FRAME colomn niet wordt gevonden
     * @throws ParserException wordt opgegooid als de inhoud van de FRAME colomn niet overeenkomt met de bestaande frames
     */
     ...
     * @param orfID int met daarin de ORF ID waarvan de BLAST resultaten moet worden op gehaald
     * @return een genested ArrayList met daarin resultaat ID, omschrijving, bitscore, query coverage, e-value, identity, positives en gaps per gevonde resultaat
     * @throws SQLException wordt opgegooid als er een exception optreed bij de SQL server
     */
     ...
     * @param columns String Array met de kolom namen waarvan de resultaten moeten worden verzameld
     * @param resultSet ResultSet waarin de resultaten van de SQL query in bevinden
